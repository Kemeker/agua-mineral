                ...
                <div className="bg-gray-800 text-white">
                        ...
                        <div className="relative flex items-center justify-between h-16">
                            ...
                            <div className="hidden sm:block sm:ml-6">
                                    <div className="flex space-x-4">
                                        ...
                                        <a href="https://wa.me/49999518238" className="px-4 py-2 rounded-md text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white" target='_blank'>WhatsApp</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="sm:hidden" id="mobile-menu">
                        <div className="px-2 pt-2 pb-3 space-y-1">
                            ...
                            <a href="https://wa.me/49999518238" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">WhatsApp</a>
                        </div>
                    </div>
                </div>
